...
//namespace vkv {
//
//static opencascade::handle<Geom_BSplineCurve> createCurve(const std::vector<vsg::dvec3>& ctrl_points,
...
//}
//
//static vsg::Geometry* createCurveGeometry(Geom_BSplineCurve* curve, const vsg::dvec4& color) {
...
//        vertices->push_back(vsg::dvec3(posi.X(), posi.Y(), posi.Z()));
//    }
...
//    geom->addPrimitiveSet(new vsg::DrawArrays(GL_LINE_STRIP, 0, nb_pnts));
//    return geom;
//}
//
//static vsg::Geometry* createPointsGeometry(const std::vector<vsg::dvec3>& points) {
//    auto vertices = new vsg::Vec3Array();
//    for (auto& pt : points) {
//        vertices->push_back(pt);
//    }
//    auto colors = new vsg::Vec4Array();
//    { colors->push_back(vsg::dvec4(1, 1, 0, 1)); }
//    auto geom = new vsg::Geometry();
//    geom->setVertexArray(vertices);
//    geom->setColorArray(colors, vsg::Array::BIND_OVERALL);
//    geom->addPrimitiveSet(new vsg::DrawArrays(GL_POINTS, 0, points.size()));
//    geom->getOrCreateStateSet()->setAttributeAndModes(new vsg::Point(4));
//    return geom;
//}
//
...
//
//    auto model = new vsg::MatrixTransform();
//    model->addChild(geod);
...
//        gp_Vec tangent;
//        adaptor.D1(param, posi, tangent);
//        pts.push_back(vsg::dvec3(posi.X(), posi.Y(), posi.Z()));
//    }

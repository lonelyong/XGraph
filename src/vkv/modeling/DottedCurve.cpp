...
//    std::vector<vsg::dvec3> pts;
//    bool                    is_closed  = false;
//    bool                    is_sampled = false;
//};
//
//static inline float calcAngle(const vsg::dvec4& pt1, const vsg::dvec4& pt2, const vsg::dvec4& pt3) {
//    vsg::dvec3 v1(pt1.x - pt2.x, pt1.y - pt2.y, pt1.z - pt2.z);
//    vsg::dvec3 v2(pt3.x - pt2.x, pt3.y - pt2.y, pt3.z - pt2.z);
//    auto       dot   = vsg::dot(v1, v2);
//    auto       len12 = vsg::length(v1) * vsg::length(v2);
//    if (len12 < 1e-6) {
//        return 1;
//    }
//    return dot / len12;
//}
//
//static void downsample(const std::vector<vsg::dvec4>& input,
//                       bool                           is_closed,
//                       float                          min_cos,
//                       float                          max_dist_squared,
//                       std::vector<vsg::dvec4>&       output) {
//    output.clear();
//
...
//            auto  dist    = vsg::length2(next_pt - pt);
...
//
//        if (pt.w < min_cos) {
//            const vsg::dvec4* prev_pt      = nullptr;
//            const vsg::dvec4* prev_prev_pt = nullptr;
//            const vsg::dvec4* next_pt      = nullptr;
//            const vsg::dvec4* next_next_pt = nullptr;
//
//            if (i == 0) {
...
//}
//
//void DottedCurve::setInputPoints(const std::vector<vsg::dvec3>& pts) {
//    d->pts = pts;
//}
//
//void DottedCurve::setInputPoints(std::vector<vsg::dvec3>&& pts) {
//    d->pts = pts;
//}
//
...
//
//    std::vector<vsg::dvec4> pts;
//    pts.reserve(d->pts.size());
//
//    for (auto& pt : d->pts) {
//        pts.push_back(vsg::dvec4(pt, 1));
//    }
//
//    std::vector<vsg::dvec4> output;
//    auto                    max_dist_squared = max_dist * max_dist;
//    auto                    min_cos          = cos(vsg::DegreesToRadians(max_angle));
//
...
//
//    for (auto& pt : output) {
//        d->pts.push_back(vsg::dvec3(pt.x, pt.y, pt.z));
//    }
//}
//
//std::vector<vsg::dvec3> DottedCurve::getPoints() const {
//    return d->pts;
//}
//
//vsg::MatrixTransform* DottedCurve::createGeometry(bool              points_visible,
//                                                  bool              lines_visible,
//                                                  const vsg::dvec4& points_color,
//                                                  const vsg::dvec4& lines_color) const {
...
//    //geom->setColorArray(colors, vsg::Array::BIND_PER_PRIMITIVE_SET);
//    //if (lines_visible) {
//    //    colors->push_back(lines_color);
//    //    geom->addPrimitiveSet(new vsg::DrawArrays(d->is_closed ? GL_LINE_LOOP : GL_LINE_STRIP, 0, vertices->size()));
//    //}
//    //if (points_visible) {
//    //    colors->push_back(points_color);
//    //    geom->addPrimitiveSet(new vsg::DrawArrays(GL_POINTS, 0, vertices->size()));
//    //}
//
...
//    //mt->addChild(geod);
//    //mt->getOrCreateStateSet()->setAttributeAndModes(new vsg::Point(3.0f));

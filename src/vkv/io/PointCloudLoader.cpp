...
//}
//
//vsg::MatrixTransform* parse(const PCPtr cloud) {
//    auto z_lower = 0.f;
//    auto z_upper = 1000.f;
...
//        }
//
//        std::vector<vsg::dvec4> color_map;
//        for (int i = 0; i < 256; i++) {
//            auto r = rand() / 32767.;
//            auto g = rand() / 32767.;
//            auto b = rand() / 32767.;
...
//                auto& pt = (*cloud)[idx];
//                vertices->push_back(vsg::dvec3(pt.x, pt.y, pt.z));
...
//            if (depth <= 1.f) {
//                colors->push_back(vsg::dvec4(1.f - depth, depth, 0.f, 1.0f));
//            }
//            else if (depth <= 2.f) {
//                colors->push_back(vsg::dvec4(0.f, 2.f - depth, depth - 1.f, 1.0f));
//            }
//        }
//    }
...
//                continue;
//            vertices->push_back((vsg::dvec3(pt.x, pt.y, pt.z)));
//            colors->push_back(vsg::dvec4(pt.r / 255., pt.g / 255., pt.b / 255., 1.0f));
//        }
//    }
//
//    geom->setVertexArray(vertices);
//    // geom->setUseVertexArrayObject(true);
//    geom->setVertexAttribArray(0, vertices, vsg::Array::BIND_PER_VERTEX);
//    geom->setVertexAttribArray(1, colors, vsg::Array::BIND_PER_VERTEX);
//    geom->addPrimitiveSet(new vsg::DrawArrays(GL_POINTS, 0, vertices->size()));
//    // geom->setUseVertexArrayObject(true);
//    // geom->setUseDisplayList(false);
//
//    auto prog = new vsg::Program();
//    prog->addShader(new vsg::Shader(vsg::Shader::VERTEX, S_VS_STR));
//    prog->addShader(new vsg::Shader(vsg::Shader::FRAGMENT, S_FS_STR));
//
//    auto point_sprite = new vsg::PointSprite();
//    point_sprite->setCoordOriginMode(vsg::PointSprite::LOWER_LEFT);
//
...
//}; // namespace
//
//vsg::MatrixTransform* PointCloudLoader::loadFile(const std::string& file) {
//    FileType type;
